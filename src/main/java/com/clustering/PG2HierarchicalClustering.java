...
//                    oldDataCentroidsI.add(centroids[j].clone());
//                    oldDataCentroidsJ.add(centroids[j].clone());
//                }
////                oldRangeI = Core.joinMultipleArray(oldRangeI, rangeI);
////                oldDataCentroidsI = Core.joinMultipleArray(oldDataCentroidsI, dataCentroidsI);
////                oldRangeJ = Core.joinMultipleArray(oldRangeJ, rangeJ);
////                oldDataCentroidsJ = Core.joinMultipleArray(oldDataCentroidsJ, dataCentroidsJ);
//
//
//
...
//
//            int size = oldRangeI.size();
//            int splitter = Math.max(oldRangeI.size() / core, Config.MAX_MATRIX_COUNT);
//            int temp = 0;
//            while (temp <= oldRangeI.size()){
//                int increment = Math.min()
//            }
//            double[] rangeI = oldRangeI.stream().mapToDouble(Double::doubleValue).toArray();
//            double[][] dataCentroidsI = new double[oldDataCentroidsI.size()][];
//            double[] rangeJ = oldRangeJ.stream().mapToDouble(Double::doubleValue).toArray();
//            double[][] dataCentroidsJ = new double[oldDataCentroidsI.size()][];
//            System.out.println(Arrays.toString(rangeJ));
//            dataCentroidsI = oldDataCentroidsI.toArray(dataCentroidsI);
//            dataCentroidsJ = oldDataCentroidsJ.toArray(dataCentroidsJ);
//
//
//
